...
- [ ] Explain what a token is used for.
    ...
    A: telling the server what information you are authorized to view and affect

- [ ] What steps can you take in your web apps to keep your data secure?

    A: implement authorization and private routes

- [ ] Describe how web servers work.

    A: hold code or programs that can be accessed or run remotely via an internet connection
